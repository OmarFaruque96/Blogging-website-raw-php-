    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="category" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">All Post Category</h6>
            <a class="collapse-item" href="categories.php">View All Category</a>
            <a class="collapse-item" href="view-all-post1.php">View All Post</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="posts" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="newpost.php">Add New Post</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="users" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">All Users Information</h6>
            <a class="collapse-item" href="allusers.php">View All Users</a>
